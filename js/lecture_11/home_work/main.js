...
const arr = Array.from(navigation);
...
arr.forEach((element) => {
    element.addEventListener('mouseover', (e) => element.classList.add('blue'));
    element.addEventListener('mouseleave', (e) => element.classList.remove('blue'));
});
...
const DATA = [
    {   id: 1,
        name: 'Loki',
        img: 'https://static.wikia.nocookie.net/disney/images/6/6c/Thor_Ragnarok_-_Loki.jpg/revision/latest?cb=20171019180420',
        desk: 'Loki, Prince of Asgard, Odinson, rightful heir of Jotunheim, and God of Mischief, is burdened with glorious purpose. His desire to be a king drives him to sow chaos in Asgard. In his lust for power, he extends his reach to Earth..',
    },
    {
        id: 2,
        name: 'Wanda Maximoff',
        img: 'https://static.wikia.nocookie.net/marveldatabase/images/a/a9/Wanda_Maximoff_%28Earth-199999%29_from_WandaVision_Season_1_9_001.png/revision/latest?cb=20210611092328',
        desk: 'Wanda Maximoff aimed her anger and grief over loss of her parents at Tony Stark, which drove her to HYDRA—where she gained powers—which drove her further to Ultron, where she gained perspective. Seeing the error of her ways, Wanda switched sides.',
    },
    {
        id: 3,
        name: 'Vision',
        img: 'https://static.wikia.nocookie.net/marvelcinematicuniverse/images/2/2f/Vision_AIW_Profile.jpg/revision/latest?cb=20180518212532',
        desk: 'A fully unique being, Vision came about thanks to a combination of Wakandan Vibranium, Asgardian lightning, an Infinity Stone, and more.',
    },
    {
        id:4,
        name: 'Loki',
...
const generateNavEl = (data) => {
    let navCont = '';
    data.forEach((hero) => {
        navCont += createNavElement(hero.name);
...
const createContent = (hero) => {
    ...
    <div class="hero">
        ...
        <p class="hero_description">${hero.desc}</p>
    </div>
    `; 
    return content
};
...
nav.addEventListener('click', (e) => {
    ...
    //1 filter arr and get the element , 2 create template for cont, 3 fill content
});
